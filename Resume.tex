...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Name
\contact{Damir Garifullin}{gosugdr@gmail.com}{+7 (921) 398-4356}
...
\begin{body}
	...
	\end{itemize}
	\emph{\textbf{Misc.:}}{} GWT, EJB, JUnit, Microsoft SQL, SQLite, Cassandra, Jasmin, Intellij Idea, Eclipse, HTML/CSS, SQL, C\#, ASP.NET, Javascript, JQuery, Node.js, Unix, Vim
\end{body}
